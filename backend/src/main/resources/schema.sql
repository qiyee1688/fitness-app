...
-- ============================================================
-- Tables: editors / knowledge_articles / article_references
-- ============================================================
...
CREATE INDEX idx_knowledge_articles_published ON knowledge_articles(published_at DESC, id)
    WHERE status = 'PUBLISHED';
CREATE INDEX idx_article_references_exercise_id ON article_references(exercise_id);
