...
class WorkoutTemplateSchemaMigrationTest {
    ...
    @Test
    void skipsMigrationWhenTemplateSchemaIsReady() throws Exception {
        ...
        verify(jdbcTemplate).queryForObject(anyString(), org.mockito.ArgumentMatchers.eq(Boolean.class));
        verifyNoMoreInteractions(jdbcTemplate);
    }

    @Test
    void appliesMigrationWhenTemplateSchemaIsIncomplete() throws Exception {
        when(jdbcTemplate.queryForObject(anyString(), org.mockito.ArgumentMatchers.eq(Boolean.class)))
                .thenReturn(false);
